...
namespace UnityEngine.Rendering.Universal
{
    ...
    [MovedFrom("UnityEngine.Rendering.LWRP")] public static class ShadowUtils
    {
        ...
        public static void RenderShadowSlice(CommandBuffer cmd, ref ScriptableRenderContext context,
            ref ShadowSliceData shadowSliceData, ref ShadowDrawingSettings settings, Vector4 shadowBias, VisibleLight shadowLight,int cascadeIndex)
        {
            RenderShadowSlice(cmd, ref context, ref shadowSliceData, ref settings,
                shadowSliceData.projectionMatrix, shadowSliceData.viewMatrix, shadowBias,shadowLight,cascadeIndex);
        }
